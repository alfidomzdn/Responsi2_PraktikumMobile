...
<template>
    <ion-modal :is-open="isOpen" @did-dismiss="cancel">
        <ion-header>
            <ion-toolbar>
                <ion-title>{{ editingId ? 'Edit Resep' : '' }} Resep Menu</ion-title>
        ...
        <ion-content>
            <ion-item>
                <ion-input v-model="todo.title" label="Masakan" label-placement="floating"
                    placeholder="Enter Title"></ion-input>
            </ion-item>
            <ion-item>
                <ion-textarea v-model="todo.description" label="Deskripsi" label-placement="floating"
